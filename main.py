...
def parse_arguments():
    ...
    # General flags
    parser.add_argument('--resource', type=str, required=True, help='ec2, s3, route53', metavar='')
    ...
    parser.add_argument('--ami', type=str, choices=['ubuntu', 'amazon-linux'], help='AMI choice (e.g., ubuntu, amazon-linux)', metavar='')
